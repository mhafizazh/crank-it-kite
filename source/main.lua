...
function pd.update()
    ...
    ship.x += math.cos(r) * ship.speed
    ship.y += math.sin(r) * ship.speed
    ...
    gfx.drawText("Wind: " .. tostring(wind.angle), 10, 10)
    gfx.drawText("Ship: " .. tostring(math.floor(ship.angle)), 10, 25)
end
